...
function generateWhatIs(tool, keywords) {
  ...
  return `
    ...
    <p>${tool.name} is a free online tool that helps you ${tool.description.toLowerCase()}. It's part of SabTools.in's collection of 460+ free tools designed for Indian users. People commonly search for ${kwMention} when they need this type of tool.</p>
