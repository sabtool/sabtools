...
function generateConclusion(tool, keywords) {
  ...
  return `
    ...
    <p><em>Last updated: ${new Date().toLocaleDateString("en-IN", { month: "long", year: "numeric" })}. This guide is part of SabTools.in's ${year} tool guides series covering 460+ free online tools for India.</em></p>
    </div><!-- end-conclusion -->
  `;
}
