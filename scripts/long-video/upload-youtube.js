...
async function uploadLongVideo(videoPath) {
  ...
  const title = "450+ FREE Online Tools for India — SabTools.in Complete Walkthrough & Tutorial 2026";
  const description = [
    "450+ FREE Online Tools — No Signup, No Download! SabTools.in ka complete walkthrough aur tutorial Hindi mein.",
    "",
  ...
  try {
    ...
    try {
      const commentText = [
        `🔗 Visit SabTools.in — 450+ FREE Online Tools: https://sabtools.in`,
        ``,
