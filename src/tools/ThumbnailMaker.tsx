  ...
  return (
    <div className="space-y-6">
      <div
        ...
        role="button"
        tabIndex={0}
        aria-label="Drop a background image here or click to upload"
        onKeyDown={(e) => {
      ...
      >
        ...
        <div className="text-sm font-semibold text-gray-700">
          {isDragging ? "Drop your image here" : image ? "Drag or click to change background image" : "Drag & drop your background image, or click to upload"}
        </div>
