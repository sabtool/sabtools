        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://x.com/Sabtoolsin" target="_blank" rel="nofollow noopener noreferrer" aria-label="Twitter" className="text-gray-500 hover:text-blue-400 transition">
              ...
              <a href="https://github.com/sabtool/sabtools" target="_blank" rel="nofollow noopener noreferrer" aria-label="GitHub" className="text-gray-500 hover:text-white transition">
