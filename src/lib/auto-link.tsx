...
export const relatedPillars: Record<string, string[]> = {
  finance: ["tax", "health", "indiaguide"],
  tax: ["finance", "indiaguide", "security"],
  image: ["pdf", "converters", "seo"],
  pdf: ["image", "indiaguide", "security"],
  ai: ["text", "seo", "developer"],
  text: ["ai", "seo", "developer"],
  seo: ["text", "ai", "developer"],
  developer: ["security", "ai", "text"],
  security: ["developer", "indiaguide", "pdf"],
  health: ["finance", "datetime", "fun"],
  fun: ["datetime", "health", "text"],
  converters: ["math", "datetime", "indiaguide"],
  math: ["converters", "datetime", "finance"],
  datetime: ["math", "converters", "health"],
  indiaguide: ["finance", "tax", "converters"],
};
